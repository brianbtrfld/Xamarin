	...
	public class CollectionViewController : UICollectionViewController
	{
		...
		public override void ItemHighlighted(UICollectionView collectionView, NSIndexPath indexPath)
		{
			...
			UIView.Animate(
				...
				animation: () =>
				{ 
					cell.ContentView.Transform = CGAffineTransform.MakeScale(1.1f, 1.1f);  // 110%
					cell.BackgroundView.Transform = CGAffineTransform.MakeScale(1.4f, 1.4f);  //140%
