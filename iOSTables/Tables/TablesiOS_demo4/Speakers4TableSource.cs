...
//				cell = new UITableViewCell (UITableViewCellStyle.Value2, speakerCellId);  // does not have UIImage
			}
			var speaker = data[indexPath.Row];
...
//			cell.Accessory = UITableViewCellAccessory.DisclosureIndicator;
			...
			// Provide i-circle button on cell, tappable, more information stuff.
			// NOTE:  i-circle icon is standard and not changeable.
		...
		public override void AccessoryButtonTapped(UITableView tableView, NSIndexPath indexPath)
		{
			...
			new UIAlertView("Session Accessory Tapped", speaker.Name, null, "OK", null).Show();
		}
	}
}