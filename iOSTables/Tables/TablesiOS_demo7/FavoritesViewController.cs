...
namespace TablesDemo
{
	public class FavoritesViewController : UITableViewController
	{
		...
		public FavoritesViewController()
		{
			...
			{
				new Session{ Title = "Keynote 1" }, 
				new Session{ Title = "Keynote 2" },
				new Session{ Title = "Keynote 3" }, 
				new Session{ Title = "Keynote 4" }
			};
		}
		...
		class FavoritesTableViewSource : UITableViewSource
		{
			...
			public override void CommitEditingStyle(UITableView tableView, UITableViewCellEditingStyle editingStyle, NSIndexPath indexPath)
			{
				...
				if (editingStyle == UITableViewCellEditingStyle.Delete)
				{
					...
					// Allows for identification of animation.
			...
			{
				// NOTE:  Return False and no rows can be moved.
